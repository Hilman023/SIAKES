...
(function (factory) {
  ...
  DataTable.defaults = {
     ...
     * * `simple` - 'Sebelumnya' and 'Selanjutnya' buttons only
     * * 'simple_numbers` - 'Sebelumnya' and 'Selanjutnya' buttons, plus page numbers
     * * `full` - 'Pertama', 'Sebelumnya', 'Selanjutnya' and 'Terakhir' buttons
     * * `full_numbers` - 'Pertama', 'Sebelumnya', 'Selanjutnya' and 'Terakhir' buttons, plus page numbers
     * * `first_last_numbers` - 'Pertama' and 'Terakhir' buttons, plus page numbers
     *
